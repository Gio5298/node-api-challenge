...
- [ ] Mention two parts of Express that you learned about this week.
        A:  routing in express and middleware

- [ ] Describe Middleware?
        A: these are functions that are run berfore the http method gets requested.

- [ ] Describe a Resource?
        A: this is what we get when a client requests a specfic endpoint 

- [ ] What can the API return to help clients know if a request was successful?
        A: it will return a status code if the form of a respone to let you know if it was successful or not 
